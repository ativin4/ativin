...
interface BlogPost {
    ...
    date: string;
    readTime: string;
    type: 'medium' | 'internal';
    url?: string; // for medium articles
    tags: string[];
}

// These will be your personal blog posts written directly on your site
const blogs: BlogPost[] = [
    // Example structure for future blog posts
    /*{
        id: 'example-post',
        title: 'Example Blog Post',
        description: 'This is where your personal blog posts will appear.',
        date: '2025-06-16',
        readTime: '5 min read',
        type: 'internal',
